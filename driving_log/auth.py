...
class Authenticator:
    ...
    def authenticate(self, account: str, password: str) -> str | None:
        password_hash = {
            ...
            "bethany": self.bethany_password_hash,
    ...
    def can_mutate(user: str) -> bool:
        return user in (ACCOUNTS["sean"], ACCOUNTS["jen"], ACCOUNTS["bethany"])
    ...
    def _credential_fingerprint(self, user: str) -> str:
        password_hash = {
            ...
            "Bethany O'Banion": self.bethany_password_hash,
